    ...
    <section className="relative py-20 md:py-24 overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto">
                    ...
                    <div className={`flex items-center gap-8 ${isLeft ? 'flex-row' : 'flex-row-reverse'}`}>
                      ...
                      <div className="relative z-10">
                        ...
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center border-4 ${
                          ...
                          {isCompleted && <Check className="w-6 h-6 text-accent" />}
                          {isCurrent && <Target className="w-6 h-6 text-white" />}
                          {isUpcoming && <Circle className="w-6 h-6 text-gray-500" />}
                        </div>
                      </div>
          ...
          >
            <div className="inline-block px-8 py-4 bg-accent/10 border-2 border-accent rounded-full">
