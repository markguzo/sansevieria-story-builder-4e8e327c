...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen pt-24 bg-white relative overflow-hidden">
      {/* Single Large Concentric Circles Background for Entire Page */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <svg className="w-full h-full min-w-[1200px] min-h-[1200px]" viewBox="0 0 1200 1200" preserveAspectRatio="xMidYMid meet">
          {[150, 250, 350, 450, 550, 650, 750, 850].map((radius, i) => (
            <circle
              key={radius}
              cx="600"
              cy="600"
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-6">
          <div className="bg-secondary/30 rounded-[2.5rem] p-8 md:p-12 text-center">
      ...
      <section className="py-12 relative z-10">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-secondary/30 rounded-[2.5rem] p-8 md:p-10">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-secondary/30 rounded-[2.5rem] p-8">
